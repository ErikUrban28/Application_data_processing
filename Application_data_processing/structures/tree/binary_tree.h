...
namespace structures
{
	...
	template <typename T>
	int BinaryTreeNode<T>::numberOfSons()
	{
		BinaryTreeNode* leftSon{ this->getLeftSon() };
		BinaryTreeNode* rightSon = { this->getRightSon() };

		if (leftSon != nullptr && rightSon != nullptr)
		{
			return 2;
		}
		else if (leftSon == nullptr && rightSon == nullptr)
		{
			return 0;
		}
		else
